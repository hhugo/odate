...
(* OASIS_START *)
(* DO NOT EDIT (digest: a58ba484ec37b8f8abd7a3319a0bc6ce) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("date-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("date-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "©\017óÎÇð\157uÝ\133\143!­\026\141ô";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
